                ...
                <form role="form" id="dataForm" method="POST" enctype="multipart/form-data">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input type="text"  name="plan_title" class="form-control" placeholder="Plan Title" value="<?php echo (isset($plan_detail['plan_title']) && $plan_detail['plan_title'] !='')? $plan_detail['plan_title'] : '';?>">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="plan_duration">
                                ...
                                <option value="1 Month" <?php echo (isset($plan_detail['plan_duration']) && $plan_detail['plan_duration'] =='1 Month')? 'selected' : '';?>>1 Month</option>
                                <option value="3 Month" <?php echo (isset($plan_detail['plan_duration']) && $plan_detail['plan_duration'] =='3 Month')? 'selected' : '';?>>3 Month</option>
                                <option value="6 Month" <?php echo (isset($plan_detail['plan_duration']) && $plan_detail['plan_duration'] =='6 Month')? 'selected' : '';?>>6 Month</option>
                                <option value="1 Year" <?php echo (isset($plan_detail['plan_duration']) && $plan_detail['plan_duration'] =='1 Year')? 'selected' : '';?>>1 Year</option>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="plan_price" class="form-control" placeholder="Plan Price" value="<?php echo (isset($plan_detail['plan_price']) && $plan_detail['plan_price'] !='')? $plan_detail['plan_price'] : '';?>">
                            <span id="dataForm_plan_price_errorloc" class="error_strings text-danger"></span>
                        </div>
                        <div class="form-group">
                            <label for="status">Status</label>
                            <select class="form-control" name="status">
                                <option value="Enabled" <?php echo (isset($plan_detail['status']) && $plan_detail['status'] =='Enabled')? 'selected' : '';?>>Enabled</option>
                                <option value="Disabled" <?php echo (isset($plan_detail['status']) && $plan_detail['status'] =='Disabled')? 'selected' : '';?>>Disabled</option>
                            </select>
                        </div>
                    </div>
